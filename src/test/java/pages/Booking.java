...
public class Booking {
    ...
    private SelenideElement familyPlusFarePrice = $("div.flights-table-fares__fare.fare-select.family-plus.mandatory-seat.middle");
    ...
    private SelenideElement chooseFirstAdultStandardSeat = $$("span.seat-click.").get(46);
    private SelenideElement chooseSecondAdultStandardSeat = $$("span.seat-click").get(47);
    private SelenideElement chooseChildStandardSeat = $$("span.seat-click").get(48);
    ...
    private SelenideElement btnOkIgotIt = $("button.core-btn-primary.same-seats");
    ...
    public Booking selectFlightFlexiPlusFarePrice(){
        familyPlusFarePrice.shouldBe(visible).scrollTo().shouldBe(clickable).hover().click();
        return this;
    }
